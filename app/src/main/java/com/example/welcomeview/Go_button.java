...
public class Go_button extends AppCompatButton {
    private int width;
    private int heigh;
    ...
    public Go_button(Context context)
    {
        super(context);
        init(context);
    }

    public Go_button(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(context);
    }

    public Go_button(Context context, AttributeSet attrs, int defStyleAttr)
    {
